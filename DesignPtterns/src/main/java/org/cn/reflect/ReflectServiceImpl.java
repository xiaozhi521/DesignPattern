...
public class ReflectServiceImpl {
    ...
    public ReflectServiceImpl getInstance(){
        ...
        try {
            object = (ReflectServiceImpl) Class.forName("org.cn.reflect.ReflectServiceImpl").newInstance();
            object.sayHello("lhz");
        }catch (Exception e){
    ...
    public Object reflect(){
        ...
        try {
            target = (ReflectServiceImpl) Class.forName("org.cn.reflect.ReflectServiceImpl").newInstance();
