...
public class HelloReflectInstance {
    ...
    public static HelloReflect getInstance(){
        ...
        try {
            helloReflect = (HelloReflect) Class.forName("org.designmode.reflect.HelloReflect").newInstance();
    ...
    public static Object getReflect(){
        ...
        try {
            object = (HelloReflect) Class.forName("org.designmode.reflect.HelloReflect").newInstance();
            //反射方法
